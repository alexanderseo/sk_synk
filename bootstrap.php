...
class bootstrap {
    ...
    public function start() {
        ...
        $this->sk_stock_products = $this->sk_stock_products->get($this->sk_fabrics);
        $this->sk_variations = $this->sk_variations->get($this->sk_fabrics);
        $this->sk_product = $this->sk_product->get($this->sk_variations, $this->sk_categories, $this->sk_fabrics);
        ...
        $this->sk_expo_products = $this->sk_expo_products->get($this->sk_fabrics);
